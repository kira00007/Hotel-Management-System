 ...
 * @author Asad Khan
 */
public class Frame9_13 extends javax.swing.JFrame {

    /**
     * Creates new form Frame9_13
     */
    public Frame9_13() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            String insert = "delete from doctor where p_id='"+value1+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frame9_13.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
