 ...
 * @author Asad Khan
 */
public class Frame9_17 extends javax.swing.JFrame {

    /**
     * Creates new form Frame9_17
     */
    public Frame9_17() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            String insert = "update nurse set nname='"+value2+"', sex='"+value3+"', age='"+value4+"' where n_id='"+value1+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frame9_17.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
